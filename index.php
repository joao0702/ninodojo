        ...
        <section class="promocoes">
            ...
            <div class="produtos">
                ...
                <div class="kimono">
                    ...
                    <button id="adicionar-carrinho-2">Adicionar ao Carrinho</button>
                </div>
                ...
                <div class="kimono">
                    ...
                    <h3>KIMONO</h3>
                    <p>R$ 399,90</p>
                  <button id="alert-button">Adicionar ao Carrinho</button>
                </div>
            </div>
        </section>
...
<script>
        ...
        document.getElementById("adicionar-carrinho").addEventListener("click", showAlert);
        document.getElementById("adicionar-carrinho-2").addEventListener("click", showAlert);
    </script>
